...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Member.farmigo_last_modified_date'
        db.add_column(u'gwcsa_heroku_member', 'farmigo_last_modified_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Member.farmigo_last_modified_date'
        db.delete_column(u'gwcsa_heroku_member', 'farmigo_last_modified_date')
