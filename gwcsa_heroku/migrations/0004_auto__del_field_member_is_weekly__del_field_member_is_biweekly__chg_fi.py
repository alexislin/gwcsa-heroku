...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Member.is_biweekly'
        db.delete_column(u'gwcsa_heroku_member', 'is_biweekly')


        # Changing field 'Member.assigned_week'
        db.alter_column(u'gwcsa_heroku_member', 'assigned_week', self.gf('django.db.models.fields.CharField')(max_length=1, null=True))
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Member.is_biweekly'
        db.add_column(u'gwcsa_heroku_member', 'is_biweekly',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'Member.assigned_week'
        db.alter_column(u'gwcsa_heroku_member', 'assigned_week', self.gf('django.db.models.fields.CharField')(default='W', max_length=1))
