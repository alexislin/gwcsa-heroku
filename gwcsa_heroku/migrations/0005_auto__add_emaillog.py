...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'gwcsa_heroku_emaillog', (
            ...
            ('to_email', self.gf('django.db.models.fields.EmailField')(max_length=254)),
            ('to_name', self.gf('django.db.models.fields.CharField')(max_length=210)),
            ('subject', self.gf('django.db.models.fields.CharField')(max_length=350)),
            ('status_code', self.gf('django.db.models.fields.CharField')(max_length=10)),
        ))
        db.send_create_signal(u'gwcsa_heroku', ['EmailLog'])


    def backwards(self, orm):
        # Deleting model 'EmailLog'
        db.delete_table(u'gwcsa_heroku_emaillog')
