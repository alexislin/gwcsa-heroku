...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Share'
        db.create_table(u'gwcsa_heroku_share', (
            ...
            ('content', self.gf('django.db.models.fields.CharField')(max_length=2)),
            ('quantity', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('frequency', self.gf('django.db.models.fields.CharField')(max_length=1)),
        ))
        db.send_create_signal(u'gwcsa_heroku', ['Share'])


    def backwards(self, orm):
        # Deleting model 'Share'
        db.delete_table(u'gwcsa_heroku_share')
